...
# Network parameters
tf.app.flags.DEFINE_integer('kernel_size', 10, 'Position kernel size')
tf.app.flags.DEFINE_integer('max_len', 90, 'Only consider sessions of this length')
...
tf.app.flags.DEFINE_integer('embedding_size', 32, 'Item id embedding size')
